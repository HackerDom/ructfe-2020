...
class Parser:
    ...
    def username(self):
        suffix = '\'s profile'
        with mumble(f'extracting username from the profile page', {AttributeError, IndexError}):
    ...
    def user_info(self, **additional_fields):
        ...
        return UserInfo(**self._merge_fields(fields, additional_fields))
    ...
    def document_info(self, **additional_fields):
        ...
        with mumble(f'extracting the author id from the document page', {TypeError, KeyError}):
        ...
        if not self.soup.select_one('form label:-soup-contains("Password")'):
            ...
            with mumble(f'extracting the signature from the document page', {AttributeError}):
        ...
        return DocumentInfo(**self._merge_fields(fields, additional_fields))
